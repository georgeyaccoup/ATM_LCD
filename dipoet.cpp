...
void Dipoet::on_pushButton_clicked()
{
    Dialog NewDialoge;
    hide();
...
void Dipoet::on_pushButton_2_clicked()
{
...
void Dipoet::on_pushButton_3_clicked()
{
    QString amount = ui->Amount_1->text();
